...
def save_entry():
    ...
    with open("C:/WhiteHat jr/Classwork/class 136/class-136-1-4-Digi-Dairy-main/class-136-1-4-Digi-Dairy-main/static/assets/data_files/data_entry.csv", "a") as f:
        f.write(entry)
